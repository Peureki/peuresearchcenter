...
<div class = "footer">
	<div class = "inner-footer">
		<h1> Created By </h1>
		<a href = "<?php echo $base;?>resources/about-me.html"> Peureki.3647 |</a>
		<a href = "<?php echo $base;?>resources/about-me.html"> Peureki#5452 |</a>
	...
	<div class = "inner-footer">
		<h1> Support </h1>
		<a href="<?php echo $base;?>/supporters.html" style = "margin-bottom: 10px;"> List of supporters </a>

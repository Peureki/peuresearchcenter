...
var sandswept = {
    events: [
        ...
        {   // [10] Inquest Core
            ...
            key: 0,
            cooldown: 60 * 12, 
            startButton: document.getElementById('timer-sandswept-10-start'),
            startSideButton: document.getElementById('sidetimer-sandswept-10-start'),
            resetButton: document.getElementById('timer-sandswept-10-reset'),
            resetSideButton: document.getElementById('sidetimer-sandswept-10-reset'),
            timeLabel: document.getElementById('timer-sandswept-10'), 
            timeSideLabel: document.getElementById('sidetimer-sandswept-10'),
            sidebox: document.getElementById('sandswept-10-sidebox'),
            num: document.getElementById('numerical-sidetimer-sandswept-10'),
            doCountdown: function() {countdown(this.status, this.key, this.cooldown, this.timeLabel, this.timeSideLabel, this.sidebox, this.num);},
        },
    ]
};

...
function insertNav(div, level){
	...
	<div class = "navbar-links">
		<ul>
			<li onmouseover = "showNav('Home', 1, ${levelParm});" onmouseout = "showNav('Home', 2, ${levelParm});"><a href = "${period}/index.html">Home</a></li>
			<li onmouseover = "showNav('Resources', 1, ${levelParm});" onmouseout = "showNav('Resources', 2, ${levelParm});" ><a href = "${period}/resources.html">Resources</a></li>
			<li onmouseover = "showNav('Benchmarks', 1, ${levelParm});" onmouseout = "showNav('Benchmarks', 2, ${levelParm});"><a href = "${period}/benchmarks.html" >Benchmarks</a></li>
			<li onmouseover = "showNav('Timers', 1, ${levelParm});" onmouseout = "showNav('Timers', 2, ${levelParm});"><a href = "${period}/timers.html">Timers</a></li>
			<li onmouseover = "showNav('Research', 1, ${levelParm});" onmouseout = "showNav('Research', 2, ${levelParm});"><a href = "${period}/research.html">Research</a></li>
			<li onmouseover = "showNav('Maps', 1, ${levelParm});" onmouseout = "showNav('Maps', 2, ${levelParm});"><a href = "${period}/maps.html">Maps</a></li>
			<li onmouseover = "showNav('Gathering', 1, ${levelParm});" onmouseout = "showNav('Gathering', 2, ${levelParm});"><a href = "${period}/gathering.html">Gathering</a></li>
			<li onmouseover = "showNav('Support', 1, ${levelParm});" onmouseout = "showNav('Support', 2, ${levelParm});"><a href = "${period}/supporters.html">Support</a></li>
		</ul>
	</div>`; 
...
function showMobileNav(box, level){
	var mainNavBox = document.getElementById(box);
	switch (level){
		case 1: period = "."; levelParm = 1; break;
		case 2: period = ".."; levelParm = 2; break; 
	}
	...
	if (mainNavBox.style.display == 'none'){
		mainNavBox.style.display = 'block';

	} else if (mainNavBox.style.display == 'block' ){
		mainNavBox.style.display = 'none'; 
	}
	else {
		mainNavBox.style.display = 'block';
	}
	mainNavBox.innerHTML = html;
}

// Details of what each subnav bar will show
function showNav(navName, num, level){
	var period; 
	switch (level){
		case 1: period = "."; break;
		case 2: period = ".."; break;
	...
	var navResourceHTML = `
		<div onmouseover = "this.style.visibility = 'visible';" onmouseout = "this.style.visibility = 'hidden';" class = "subNav" >
	...
	var navMapHTML = `
		<div onmouseover = "this.style.visibility = 'visible';" onmouseout = "this.style.visibility = 'hidden';" class = "subNav" >
			...
			<ul>
				...
				<li><a href = "${period}/maps/frostgorge-sound.html"> Frostgorge Sound </a></li>
			</ul>

...
<body>
	...
	<div class = "page-box">
		...
		<div class = "small-description">
			...
			<br><br>
			<div >
				<img src = "../images/auric-basin/event-1.jpg" style = "display: block; margin-left: auto; margin-right: auto; width: 60%;">
			</div>

			<br>
			South pylon chain is great because it's quick and summons an event called, <b>"Destroy the feeder to prevent the blighted sapling from producing Mordrem"</b>. This event occurs 3 times, both during the main event chain and after the southern pylon has been activated. It is important to note that once the pylon has been activiated, there is a champion event called, "Prevent Blight [name] from reaching the blighted saplings". In order to spawn the 3 events again, this event must <b> fail</b>. Otherwise, it will spawn this single champion event. If someone does do the event, another similar event will spawn and let it also fail until the 3 blighted sapling events spawn. Use my <a href = "../timers/auric-basin.html"><u>timer page to help with the time for when it spawns</u></a>.

			<br><br>
			<div style = "display: flex; align-items: center; justify-content: space-between;">
				<img src = "../images/auric-basin/event-2.jpg" style = "width: 49%;">
				<img src = "../images/auric-basin/event-3.jpg" style = "width: 49%;">
			</div>

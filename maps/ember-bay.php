...
<body>
	...
	<div class = "page-box">
		...
		<div class = "map-image-box">
			<img class = "map-image" title = "Ember Bay Nodes" src = "https://static.wixstatic.com/media/1529bd_4b813f5e757f4b26b7fb48ab678752fb~mv2.jpg/v1/fill/w_868,h_649,al_c,q_85,usm_0.66_1.00_0.01/Ember%20Bay%20Gathering.webp">
		</div>
		...
		<table id = "nodes-sort" class = "nodes">
			...
			<tr> 
				...
				<td><img class = "nodes-image" title = "Petrified Wood" src = "https://wiki.guildwars2.com/images/0/00/Petrified_Wood.png">
				</td>
				<td class = "nodes-node"> Petrified Wood </td>
			...
			<tr> 
				...
				<td><img class = "nodes-image" title = "Passiflora" src = "https://wiki.guildwars2.com/images/a/ab/Passion_Flower.png">
				</td>
				<td class = "nodes-node"> Passiflora </td>
				<td class = "nodes-info"> There are a couple regular passiflora and there's generally 1 Blooming Passiflora </td>
				<td class = "nodes-cooldown"> 1 hour for Passiflora. ??? hour for Blooming </td>
			</tr>

			<tr> 
				<td id = "3" class = "nodes-low-box"> Plant </td> 
				<td><img class = "nodes-image" title = "Coral" src = "https://wiki.guildwars2.com/images/f/ff/Coral_Orb.png">
				</td>
				<td class = "nodes-node"> Coral </td>
				<td class = "nodes-info"> Chance to receive Coral Orbs </td>
				<td class = "nodes-cooldown"> 1 hour </td>
			</tr>

			<tr> 
				<td id = "1" class = "nodes-high-box"> Plant </td> 
				<td><img class = "nodes-image" title = "Lotus Root" src = "https://wiki.guildwars2.com/images/0/03/Lotus_Root.png">
				</td>
				<td class = "nodes-node"> Lotus Root </td>
